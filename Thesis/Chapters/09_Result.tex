...
Wie in Abbildung 6 zusehen ist, hat GraphQL bei der Abfrage eines einzelnen Personenobjekts eine deutlich niedrigere Latenz als die jeweilige REST API. Die zugrundeliegende Datenbank wirkt sich hierbei nur gering aus.
