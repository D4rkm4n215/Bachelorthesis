...
\newcommand{\reprttopic}{GraphQL und REST im Kontext relationaler und graphbasierter Datenbanken hinsichtlich Latenz bei unterschiedlichen Lastbedingungen}
...
\include{Chapters/06_Datamodelling}
\include{Chapters/07_Systemdesign}
\include{Chapters/08_Implementation}
\include{Chapters/09_Result}
